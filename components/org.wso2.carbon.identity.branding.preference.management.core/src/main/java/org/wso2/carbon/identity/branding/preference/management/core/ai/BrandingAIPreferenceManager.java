...
public interface BrandingAIPreferenceManager {
    ...
    String generateBrandingPreference(String websiteURL) throws BrandingAIServerException, BrandingAIClientException;

    Object getBrandingPreferenceGenerationStatus(String operationId) throws BrandingAIServerException,
            BrandingAIClientException;

    Object getBrandingPreferenceGenerationResult(String operationId) throws BrandingAIServerException,
            BrandingAIClientException;
}
