 ...
 */
public class BrandingAIServerException extends Exception {

    private String errorCode;
    private BrandingAIPreferenceManagerImpl.HttpResponseWrapper brandingAIResponse;

    public BrandingAIServerException(String message, String errorCode) {
     ...
     */
    public BrandingAIServerException(BrandingAIPreferenceManagerImpl.HttpResponseWrapper httpResponseWrapper,
    ...
    public BrandingAIServerException(String message, Throwable cause) {

        super(cause);
    }

    public BrandingAIServerException(String message, String errorCode, Throwable cause) {
